...
namespace MageMe\WebFormsKlaviyo\Ui\Component\Result\Listing\MassActions\SubActions;
...
class Klaviyo extends Action
{
    ...
    {
        return [
            'type' => 'klaviyo_send_data',
            'label' => __('Send Data'),
            'url' => $this->urlBuilder->getUrl(
                'webformsklaviyo/result/ajaxSendSubmission'
            ),
            'isAjax' => true,
            'confirm' => [
                'title' => __('Send Data'),
